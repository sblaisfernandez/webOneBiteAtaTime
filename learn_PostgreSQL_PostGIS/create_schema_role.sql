...
/*
 * After logging in as dev1, create a new table
 */
SET
    ROLE dev1;
...
CREATE ROLE rpt_user WITH login PASSWORD 'pgdaychicago';
...
GRANT
SELECT
    ON ALL TABLES IN SCHEMA public TO rpt_user;
